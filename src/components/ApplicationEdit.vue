  ...
  <div class="application-add">
    <div class="confirm-dialog">
      <el-dialog
        ...
        <span style="font-size: 16px;font-weight: bolder;color:#555;">确定更新该应用的信息吗？</span>
...
<script>
  export default {
    ...
    data () {
      return {
        ...
        baseInfoData:[
          ...
          {param:"状态",value:"",desc:"状态：删除，正常"},
          {param:"创建时间",value:"",desc:"应用号创建时间"},
        ],
        createApp:{
          appId:"",
          appKey:"",
    ...
    methods: {
      ...
      getAppDate(){
        this.createApp.appId = this.$route.query.appId;
        this.createApp.appKey = this.$route.query.appKey;
        this.createApp.status= this.$route.query.status;
        this.createApp.createDate = this.$route.query.createDate;
      }
    },
    created(){
      this.getAppDate();
